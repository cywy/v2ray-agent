...
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/cywy/v2ray-agent/master/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```

- Development Version【开发版】

```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/cywy/v2ray-agent/dev/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```

# 示例图

<img src="https://raw.githubusercontent.com/cywy/v2ray-agent/master/fodder/install/install.jpg" width=700>
